...
namespace KanducarValent_Laura_0246111632.Controllers
{
        ...
        GuestManagerDbContext _dbContext) : Controller
    {
        ...
        {
            var accomodation = _dbContext.Accommodations.Find(accomodationId);
        ...
        public IActionResult Create(Reservation model)
        {
            ...
            var accomodation = _dbContext.Accommodations.FirstOrDefault(a => a.ID == model.AccommodationID);
            if (accomodation == null)
                return NotFound();
            ...
            var overlappingReservation = _dbContext.Reservations
                .Where(r => r.AccommodationID == model.AccommodationID)
                .Any(r =>
            ...
            if (ModelState.IsValid)
            {
                ...
                var acc = _dbContext.Accommodations.FirstOrDefault(a => a.ID == model.AccommodationID);
        ...
        {
            var accomodation = _dbContext.Accommodations.Find(model.AccommodationID);
            if (accomodation == null)
                return NotFound();
            ...
            var overlapping = _dbContext.Reservations
                .Any(r => r.AccommodationID == model.AccommodationID &&
                          model.StartDate < r.EndDate &&
                          model.EndDate > r.StartDate);
        ...
        private void FillAccommodationDropdown()
        {
            ViewBag.Accommodations = new SelectList(_dbContext.Accommodations, "ID", "Name");
        }
        ...
        private void FillDropdownValues(int? selectedId = null)
        {
            ...
            foreach (var category in _dbContext.Accommodations)
            {
            ...
            ViewBag.Accommodations = selectItems;
        }
        ...
        public IActionResult EditManual(int id)
        {
            ...
            FillDropdownValues(model.AccommodationID);
            return View(model);
        }
        [Authorize(Roles = "Owner")]
        [HttpPost]
        ...
        public async Task<IActionResult> EditManualPost(int id)
        {
            ...
            if (ok)
            {
                var accomodation = _dbContext.Accommodations.Find(res.AccommodationID);
                ...
                var overlapping = _dbContext.Reservations
                    .Any(r => r.AccommodationID == res.AccommodationID &&
                              r.ID != res.ID &&
            ...
            FillDropdownValues(res.AccommodationID);
            return View(res);
        }
